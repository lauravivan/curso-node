...
![Transformação do JS para C++](images/module-1/JS-to-C++.png)
...
![Event Loop](images/module-1/event-loop.png)
...
Retorno:
![Usuário undefined](images/module-1/user-undefined.png)
...
![Uso de Callback para retornar usuário](images/module-1/user-callback.png)
...
![Uso de Callback para retornar número de telefone](images/module-1/phone-number-callback.png)

Por fim, faz-se o mesmo com endereço.

![Uso de Callback para retornar endereço](images/module-1/address-callback.png)

Depois de todos os Callbacks construídos e aninhados, é possível visualizar todos os dados.

![Informações do usuário](images/module-1/all-informations-printed.png)
...
![Refatoração do Callback de Usuário para Promise](images/module-1/user-promise.png)
...
![Retorno de erro na Promise de Usuário](images/module-1/user-promise-error.png)
...
![Resultado com Promises](images/module-1/all-promises.png)
...
![Tempo de resposta maior com async/await](images/module-1/async-await-longer.png)

![Tempo de resposta menor com async/await](images/module-1/async-await-shorter.png)
...
![Observer Design Pattern](images/module-1/observer.png)
